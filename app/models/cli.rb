...
class TakeFlight
    ...
    #             puts "#{index}. #{flight.destination}"
    #         end
    #         puts "Please select by typing in the appropriate number:\n\n"
    #         flight_input = gets.chomp.to_i - 1 
    #         flight = flights[flight_input] #find_by
    ...
    def goodbye
        # binding.pry
        if @ticket.seating == 1
            puts "\nBooking Agent: Enjoy #{@ticket.flight.destination}. Your ticket will be $500, plus a $55 booking fee."
            puts "Booking Agent: For a grand total of $555. You will be flying first class."
        elsif @ticket.seating == 2
            puts "\nBooking Agent: Enjoy #{@ticket.flight.destination}. Your ticket will be $100, plus a $55 booking fee."
            puts "Booking Agent: For a grand total of $155. You will be flying economy."
          else
            puts "\nBooking Agent: Let's try that again."
        # sleep 2
            seating
